...
This tool is a very user-friendly tool to import any model you'd like into Blender. It imports the mesh, bones, weights and textures. Allows saving the textures (.png) aswell.
=======
# Kotor Importer for Blender
